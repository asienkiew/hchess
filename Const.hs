...
whitePawnEval = V.fromList $ reverse       [ 0,  0,  0,  0,  0,  0,  0,  0,
...
whiteKnightEval =  V.fromList $ reverse   [-50,-40,-30,-30,-30,-30,-40,-50,
                                           -40,-20,  0,  0,  0,  0,-20,-40,
...
whiteBishopEval =  V.fromList $ reverse   [-20,-10,-10,-10,-10,-10,-10,-20,
                                           -10,  0,  0,  0,  0,  0,  0,-10,
                                           -10,  0,  5, 10, 10,  5,  0,-10,
                                           -10,  5,  5, 10, 10,  5,  5,-10,
...
whiteRookEval =  V.fromList $ reverse      [ 0,  0,  0,  0,  0,  0,  0,  0,
...
whiteQueenEval =  V.fromList $ reverse    [-20,-10,-10, -5, -5,-10,-10,-20,
                                           -10,  0,  0,  0,  0,  0,  0,-10,
                                           -10,  0,  5,  5,  5,  5,  0,-10,
                                            -5,  0,  5,  5,  5,  5,  0, -5,
                                             0,  0,  5,  5,  5,  5,  0, -5,
...
whiteKingMiddleEval = V.fromList $ reverse[-30,-40,-40,-50,-50,-40,-40,-30,
...
whiteKingEndEval =  V.fromList $ reverse  [-50,-40,-30,-20,-20,-30,-40,-50,
